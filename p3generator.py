...
while True:
    ...
    if (0 <= rnd < 0.10):
        ...
        response = iot.publish(
             topic='/iotws/devdata/temperature',
             payload=data
        )
    elif (0.20<= rnd < 0.30):
